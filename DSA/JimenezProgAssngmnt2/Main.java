...
For example, in converting to binary, number 6 requires three such divisions: 6/2 = 3 remain-
der 0, 3/2 = 1 remainder 1, and finally, 1/2 = 0 remainder 1. The remainders 0, 1, and
...
public class Main {
    ...
    static void division(double x, int base){
        if(base >= 11 && base <= 27)
            division(x%base, base);
    }
}
